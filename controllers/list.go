...
// @Success 201 {int} models.List
// @Failure 403 body is empty
// @router / [post]
func (c *ListController) Post() {
	var v models.List
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddList(&v); err == nil {
...
// @router /:id [get]
func (c *ListController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v, err := models.GetListById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *ListController) GetAll() {
	...
	l, err := models.GetAllList(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
